...
void Install_RadioModem(S_STRUCT_CONFIGURATION *loc_ps_config)
{
	...
	switch(loc_ps_config->s_gene.u8_mode_radio_modem)
	{
		case MODE_RADIO_MODEM_ACCESS_POINT:
			...
			printf("**************************************************************************\n");
			sleep(1);//Add by VuHai
			//Add by VuHai
			CmdSystem_Generique("cp -R /lib/firmware/ath10k/10.1/firmware-2.bin_10.1.467.2-1 /lib/firmware/ath10k/QCA988X/hw2.0/firmware-2.bin");
			sleep(1);
			//Fin Add by VuHai
			...
			//tempo  de 1 seconde
			sleep(1);
			//CmdSystem_Generique("iw phy#0 set antenna 3 3");
			...
			Install_Wifi(loc_ps_config);//Modif by VuHai
		...
		case MODE_RADIO_MODEM_STATION:
			...
			//Add by VuHai
			//CmdSystem_Generique("cp -R /lib/firmware/ath10k/999/firmware-2.bin_999.999.0.636 /lib/firmware/ath10k/QCA988X/hw2.0/firmware-2.bin");
			CmdSystem_Generique("cp -R /lib/firmware/ath10k//CT/firmware-2-ct-non-commercial.bin /lib/firmware/ath10k/QCA988X/hw2.0/firmware-2.bin");
			sleep(1);
			//Fin Add by VuHai
			...
			//Configuration du Wifi
			Install_Wifi(loc_ps_config);//Modif by VuHai
			Install_AdvWifi(loc_ps_config);//Modif by VuHai
		...
		case MODE_RADIO_MODEM_MONITOR:
			...
			printf("**************************************************************************\n");
			printf("*****************MODE_RADIO_MODEM_MONITOR****************************\n");
			printf("**************************************************************************\n");
